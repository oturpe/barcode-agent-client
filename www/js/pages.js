...
define(['js/logging'],function(logging) {
    ...
    exports.PageView = function(logger,renderer) {
        this.logger = logger;
    ...
    exports.DocumentPageExtractor = function(logger,document) {
        this.logger = logger;
        this.document = document;
    };

    exports.DocumentPageExtractor.prototype = {
