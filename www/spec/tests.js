/*global describe,beforeEach,it,spyOn,runs,waitsFor,expect,jasmine*/

define(['js/app','jasmine/jasmine'],
    function(app) {
        'use strict';
            ...
            function() {
                describe('Logger',
                    function() {
                        ...
                        it('sends prefixed log messages to given base logger',
                            function() {
                ...
                describe('Settings',function() {
                    ...
                    it('forwards get requests to underlying storage',
                        function() {
                    ...
                    it('forwards set requests to underlying storage',
                        function() {
                            var settings = new app.Settings(logger,storage);
                            ...
                            expect(storage.setItem)
                                    .toHaveBeenCalledWith('foobar',12);
                        });
                    ...
                    it('returns undefined if there is no default value',
                        function() {
                            var settings, value;
                ...
                describe('PageView',
                    function() {
                        ...
                        it('going to page updates current page',
                            function() {
                                var testPage;
